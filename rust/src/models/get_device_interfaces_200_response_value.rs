...
pub struct GetDeviceInterfaces200ResponseValue {
...
impl GetDeviceInterfaces200ResponseValue {
    pub fn new(name: String, enabled: bool, primary: models::IpAddressWithPrefix) -> GetDeviceInterfaces200ResponseValue {
        GetDeviceInterfaces200ResponseValue {
            name,
            description: None,
            enabled,
            speed: None,
