...
pub struct SchemasNetworkInterface {
    /// Interface name
    #[serde(rename = "name")]
    pub name: String,
    /// Interface type
...
impl SchemasNetworkInterface {
    /// Network interface configuration and status
    pub fn new(name: String, r#type: Type, enabled: bool) -> SchemasNetworkInterface {
        SchemasNetworkInterface {
            name,
            r#type,
            description: None,
            enabled,
